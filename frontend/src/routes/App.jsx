...
const ForgotPassword = lazy(
  () => import("../components/Signin_Register/ForgotPassword"),
);
const About_us = lazy(() => import("../components/About Us/About_us"));
const TermsConditions = lazy(
  () => import("../routes/pages/TermsAndConditionsPage"),
);
const PrivacyPolicy = lazy(
  () => import("../routes/pages/PrivacyAndPolicyPage"),
);
...
const App = () => {
  ...
  const addToWishlist = async (_id) => {
    if (userData) {
      ...
      if (b) {
        await axios
          .post("/api/removefromWishlist", { productID: _id })
          .then((result) => {
            fetchWishList();
          });
      } else {
  ...
  const router = createBrowserRouter(
    createRoutesFromElements(
      <>
        ...
        <Route
          exact
          path="/Products/:categoryID/bag/:status"
        ...
        <Route
          exact
          path="/Products/:categoryID/:productID/bag/:status"
          element={<ProductDetailsPage />}
        />
        ...
        <Route
          exact
          path="/Orders/:orders/bag/:status"
          element={<OrdersPage />}
        />
        <Route exact path="/ReserveTable" element={<ReserveTablePage />} />
        <Route
          exact
          path="/ReserveTable/status/:status"
        ...
        <Route
          exact
          path="/auth/login/forgetpassword"
  ...
  return (
    <Notification.Provider
      value={{ notification: notification, checkUserAlreadyLogin }}
    >
      <UserData.Provider
        value={{
          userData,
